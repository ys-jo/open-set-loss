...
def efficientnet_b0(custom_class_num) -> EfficientNet:
...
def efficientnet_b1(custom_class_num) -> EfficientNet:
...
def efficientnet_b2(custom_class_num) -> EfficientNet:
...
def efficientnet_b3(custom_class_num) -> EfficientNet:
